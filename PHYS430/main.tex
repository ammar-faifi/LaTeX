...
\begin{itemize}
	...
	\item Using Stirling's approximation for factorial of a large number
	      ...
	      \end{align}
	\item Suppose $N$ oscillators for each solid, the approximated multiplicity is
	      \begin{align}
...
\begin{itemize}
	...
	\item To have a finite number of microstates we invoke quantum mechanics principles of wavefunction,
	      which is spread in both position and momentum spaces; it adheres to the
